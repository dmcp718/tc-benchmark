#!/usr/bin/env python3
"""
tfbench-win - TUI visualizer for tframetest benchmark results (Windows version)

A tool to run and visualize tframetest benchmarks with rich TUI components.
Windows-specific adaptations for path handling and executable detection.
"""
...
class BenchmarkRunner:
    ...
    def run_test(self, write_size: str, num_frames: int, threads: int,
        ...
        # Build command - Use .exe on Windows
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="TUI visualizer for tframetest benchmarks (Windows version)",
...
Examples (Windows):
  ...
  # Run with CSV export
  python tfbench-win.py -w 4k -n 500 -t 8 D:\\storage --csv results.csv

  # Run with more frames and custom timeout
  python tfbench-win.py -w 4k -n 2000 -t 16 E:\\storage --timeout 3600

  # Multiple read iterations to observe cache behavior
  python tfbench-win.py -w 4k -n 500 -t 8 C:\\storage --reads 4

Note: Ensure tframetest.exe is in your PATH or in the same directory.
        """
    )
